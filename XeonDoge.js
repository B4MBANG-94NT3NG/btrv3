...
cmhit = []
fake = "BTR X-BOT OFFICIAL VERIFIED✅"
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*BTR X-BOT OFFICIAL*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/CQqzbz4WczbB579uLIYlXj', "groupName": `Bambang Bot Inc.`, "footerText": "*BTR X-BOT OFFICIAL*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "GOOD MORNING"; break;
                case 1: jamss = "GOOD MORNING"; break;
                case 2: jamss = "GOOD MORNING"; break;
                case 3: jamss = "GOOD MORNING"; break;
                case 4: jamss = "GOOD MORNING"; break;
                case 5: jamss = "GOOD MORNING"; break;
                case 6: jamss = "GOOD MORNING"; break;
                case 7: jamss = "GOOD MORNING"; break;
                case 8: jamss = "GOOD AFTERNOON"; break;
                case 9: jamss = "GOOD AFTERNOON"; break;
                case 10: jamss = "GOOD AFTERNOON"; break;
                ...
                case 19: jamss = "GOOD NIGHT"; break;
...
const ftex = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `*${botName} by Bambang Bot Inc.*`,
                 "title": `_${botName}_`,
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*BTR X-BOT OFFICIAL*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `BTR X-BOT OFFICIAL`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/916909137213`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*BTR X-BOT OFFICIAL*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://instagram.com/btr_three')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/BambangOfficial')
}
...
case 'stupid':
      ...
      if (!isGroup) return reply(mess.only.group)
        ...
        break
        //funmenu by  Bambang Tri R
                        case 'uglycheck':
					// source code by  Bambang Tri R⛔
...
stamtus =`❏ 「 \`\`\`MAKER MENU\`\`\` 」
────────────────────
_example: ${prefix}throne  Bambang Tri R_
────────────────────
 ➤  ${prefix}write 「 text 」
 ➤  ${prefix}throne 「 text 」
 ➤  ${prefix}logoff 「 text 」
...
break
       ...
       case 'logoa':
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command}  Bambang Tri R&lol*`)
                   var F = body.slice(7)
				   var F1 = F.split("|")[0];
				   var F2 = F.split("|")[1]; 
                   reply(mess.wait)
...
break
//nsfw by  Bambang Tri Ry workshop
case 'nsfw':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
...
ini_list.push({
"displayName": `BTR X-BOT OFFICIAL Developer`,
...
_BASE : Bambang Bot Inc._
_ORI SCRIPT : BTR X-BOT OFFICIAL Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `BTR X-BOT OFFICIAL`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `BTR X-BOT OFFICIAL Script`,
...
const btnbc = {
    ...
    footerText: '*_BTR X-BOT OFFICIAL BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`BTR X-BOT OFFICIAL`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY BTR X-BOT OFFICIAL`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `BTR X-BOT OFFICIAL`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `BTR X-BOT OFFICIAL`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_BTR X-BOT OFFICIAL_*',
    buttons: punten,
    headerType: 1
}
