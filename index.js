...
const starts = async (dogexeon = new WAConnection()) => {
	...
	console.log(color('\n> YT CHANNEL: Bambang Official ','silver'))
console.log(color('> GITHUB: Bambang-Gans ','silver'))
console.log(color('> WA NUMBER: +6282313021398 ','silver'))
console.log(color('  Bambang Bot Inc. 2021','mediumseagreen'))
	dogexeon.browserDescription = [ 'Subscribe Bambang', 'ubuntu', '3.0' ]
